...
Características principales de Django:<br><br>
Completo: <br>Sigue la filosofía “Baterías incluidas” y provee casi todo lo que los desarrolladores quisieran que tenga “de fábrica”. Todo lo que necesitas es parte de un único “producto”, lo que facilita el desarrollo y mantiene la consistencia.<br>
Versátil: <br>Puede ser usado para construir casi cualquier tipo de sitio web, desde sistemas manejadores de contenidos y wikis hasta redes sociales y sitios de noticias. Además, puede funcionar con cualquier framework en el lado del cliente y devolver contenido en diversos formatos (HTML, RSS feeds, JSON, XML, etc.).
