...
<body>
    ...
    <form action="#" method="POST">
        <div>
            ...
            <input type="text" id="nombre" name="nombre" required placeholder="Escriba aquì su nombre">
        </div>
        <div>
            <label for="email"><strong>Correo Electrónico:</strong></label>
            <input type="email" id="email" name="email" required placeholder="Escriba aquì su correo electrónico">
        </div>
        <div>
            <label for="comentario"><strong>Comentarios:</strong></label>
            <textarea id="comentario" name="comentario" rows="4" required placeholder="Déjenos un breve comtenario"></textarea>
        </div>
        <div>
